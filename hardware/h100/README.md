...
|---|---|---|---|
| Reasoner/critic | Llama-3.3-Nemotron-Super-49B (NIM) or DeepSeek-R1-Distill-70B | NIM container / vLLM FP8 | planner + critic + escalation target |
| Heavy executor | Qwen3 32B FP8 or Llama 3.3 70B AWQ | vLLM | bulk high-quality execution |
