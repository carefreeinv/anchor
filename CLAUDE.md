...
- Work plans: `.plans/` (dotdir; **fully gitignored in this repo only** — consumer projects track `.plans/` and only ignore `*.local.md`). Run **`/work`**. Scaffold source: `anchor/scaffold/plans/`
