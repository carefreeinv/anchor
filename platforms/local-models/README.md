...
1. **One task spec per fresh context.** Small models degrade fast with context length; never run long conversations. `.anchor/scripts/orchestrate.py` enforces this.
