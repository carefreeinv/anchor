...
- Mistral's terseness means it may skip the `## How to verify` footer under load — enforce with a format check in the pipeline (reject and retry outputs missing footers; `.anchor/scripts/orchestrate.py` does this).
